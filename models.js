...
export const templates = {
  hybrid: () => ({
    figure: figureMeta(
      ...
      ["Image", "Feature Maps", "Patchify", "Tokens", "Transformer", "Classifier", "Prediction"],
    ),
    nodes: [
  ...
  cnn: () => ({
    figure: figureMeta(
      ...
      ["Input", "Conv 1", "Pool 1", "Conv 2", "Pool 2", "Flatten", "Dense 1", "Dense 2", "Softmax"],
    ),
    nodes: [
  ...
  resnet: () => ({
    figure: figureMeta(
      ...
      ["Input", "Stem", "Block 1", "Residual Block", "Block 2", "Pool", "Head"],
    ),
    nodes: [
      ...
      createNode("res-b1b", "compound", 1260, 590, 300, 220, "Bottleneck", "1x1 · 3x3 · shortcut", "#c9855f", 2, { compoundKind: "residual", badge: "x4" }),
    ...
    edges: [
      ...
      createEdge("res-b1b", "res-b2", "stage 3", "signal"),
      createEdge("res-pool0", "res-b1b", "identity", "skip"),
  ...
  unet: () => ({
    figure: figureMeta(
      ...
      ["Input", "Encoder 1", "Downsample 1", "Encoder 2", "Bottleneck", "Concat 2", "Decoder 2", "Concat 1", "Decoder 1", "Mask"],
    ),
    nodes: [
      createNode("unet-input", "tensor", 255, 660, 122, 188, "Image", "512 x 512", "#d7c28d", 0, { depth: 22 }),
      createNode("unet-e1", "compound", 505, 650, 250, 180, "Encoder 64", "512 x 512", "#b86655", 1, { compoundKind: "stage", badge: "E1" }),
      createNode("unet-p1", "pool", 760, 702, 90, 90, "MaxPool", "256 x 256", "#e6d49a", 2),
      createNode("unet-e2", "compound", 1000, 650, 250, 180, "Encoder 128", "256 x 256", "#c9855f", 3, { compoundKind: "stage", badge: "E2" }),
      ...
      createNode("unet-d2", "compound", 1785, 650, 250, 180, "Decoder 128", "256 x 256", "#6fa3a0", 6, { compoundKind: "stage", badge: "D2" }),
      createNode("unet-cat1", "concat", 2050, 698, 78, 78, "Concat", "skip e1", "#e6d49a", 7),
      createNode("unet-d1", "compound", 2160, 650, 250, 180, "Decoder 64", "512 x 512", "#9abcb5", 8, { compoundKind: "stage", badge: "D1" }),
  ...
  diffusion: () => ({
    figure: figureMeta(
      ...
      ["Noise", "Time / Condition", "Downsample", "Downsample 2", "Diffusion Core", "Concat", "Decoder", "Denoised"],
    ),
    nodes: [
      ...
      createNode("diff-mid", "compound", 1305, 585, 320, 250, "Denoise Core", "latent + timestep + condition", "#4e8790", 4, { compoundKind: "diffusion", note: "condition" }),
    ...
    edges: [
      ...
      createEdge("diff-t", "diff-mid", "time", "skip"),
      createEdge("diff-cond", "diff-mid", "condition", "attention"),
  ...
  unet3d: () => ({
    figure: figureMeta(
      ...
      ["Volume", "3D Enc I", "3D Enc II", "Latent Cube", "Concat II", "3D Dec II", "Concat I", "3D Dec I", "Segmentation"],
    ),
    nodes: [
      createNode("vol-input", "volume", 250, 650, 145, 210, "CT Volume", "128 x 128 x 96", "#d7c28d", 0, { depth: 78, z: 58, note: "D x H x W" }),
      createNode("vol-e1", "compound", 525, 640, 300, 220, "3D Encoder 32", "32 channels", "#b86655", 1, { compoundKind: "volume-stage", badge: "E1" }),
      createNode("vol-e2", "compound", 875, 640, 300, 220, "3D Encoder 64", "64 channels", "#c9855f", 2, { compoundKind: "volume-stage", badge: "E2" }),
      ...
      createNode("vol-d2", "compound", 1740, 640, 300, 220, "3D Decoder 64", "64 channels", "#6fa3a0", 5, { compoundKind: "volume-stage", badge: "D2" }),
      createNode("vol-cat1", "concat", 2075, 690, 78, 78, "Concat", "vol skip", "#e6d49a", 6),
      createNode("vol-d1", "compound", 2090, 640, 300, 220, "3D Decoder 32", "32 channels", "#9abcb5", 7, { compoundKind: "volume-stage", badge: "D1" }),
