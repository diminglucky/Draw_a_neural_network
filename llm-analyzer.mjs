...
const SYSTEM_PROMPT = [
  ...
  "   should be emitted as a SINGLE compound node, NOT flattened into loose layers:",
  "   set family \"custom\", compoundKind \"module\", and put the module's internal layers into",
  "   attributes.internalGraph = { \"nodes\": [inner layers with local ids], \"edges\": [inner edges] }.",
  "   Only a plain inline conv+bn+relu run should be decomposed into regular top-level nodes.",
